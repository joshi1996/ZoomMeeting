...
import com.example.zoommeeting.initsdk.InitAuthSDKCallback;
import com.example.zoommeeting.initsdk.InitAuthSDKHelper;
import com.example.zoommeeting.startjoinmeeting.UserLoginCallback;
...
public class MainActivity extends AppCompatActivity implements InitAuthSDKCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InitAuthSDKHelper.getInstance().initSDK(MainActivity.this, this);
    ...
    public void onClickJoin(View view) {
        ...
        ZoomSDK.getInstance().getMeetingService().joinMeetingWithParams(MainActivity.this, params,joinMeetingOptions);
    }
